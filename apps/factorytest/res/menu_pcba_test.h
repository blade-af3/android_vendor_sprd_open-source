...
enum {
	...
	MENUTITLE(0,0,TEST_VB_BL, show_pcba_vb_bl_menu)//bcamera and flash
	MENUTITLE(4,4,TEST_KEY, test_key_start)
	MENUTITLE(5,7,TEST_FCAMERA, test_fcamera_start)
	MENUTITLE(0,0,TEST_BCAMERA_FLASH, show_pcba_bcamera_test_menu)//bcamera and flash
	MENUTITLE(0,0,TEST_PHONE_LOOPBACK, show_pcba_phone_loop_test_menu)
	MENUTITLE(0,0,TEST_VOICE, show_pcba_voice_test_menu)
	...
	MENUTITLE(0,0,TEST_SENSOR, show_pcba_sensor_test_menu)
	MENUTITLE(20,22,TEST_BT, test_bt_start)//+++++++++
	MENUTITLE(21,23,TEST_WIFI, test_wifi_start) //+++++++++
	MENUTITLE(22,24,TEST_GPS, test_gps_start)//++++++++++
	MENUTITLE(23,27,TEST_TEL, test_tel_start)//++++++++++
	MENUTITLE(24,26,TEST_OTG, test_otg_start)//++++++++++
	MENUTITLE(25,29,CALI_INFO, test_cali_info)
	MENUTITLE(26,30,VERSION, test_version_show)
	//OTG
	//DIAL
