...
CryptoX_Result NSS_LoadPublicKeyFromFile(const char *publicKeyFile,
                                         SECKEYPublicKey **publicKey,
                                         CERTCertificate **cert);
...
#define CryptoX_LoadPublicKeyFromFile(CryptoHandle, certData, dataSize, \
                              publicKey, keyName, cert) \
  NSS_LoadPublicKeyFromFile(keyName, publicKey, cert)
